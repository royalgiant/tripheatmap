...
class OfferAcceptedHostMailerTest < ActionMailer::TestCase
  ...
  test "sends notification to host with correct details" do
    mail = OfferAcceptedHostMailer.notify(@offer)

    assert_equal "Your offer was accepted! - Cozy Studio", mail.subject
